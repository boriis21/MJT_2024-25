### :warning: [ORIGINAL TASK](https://github.com/fmi/java-course/tree/master/08-lambdas-and-stream-api/lab) :warning:
...
public class bg.sofia.uni.fmi.mjt.frauddetector.Main {
